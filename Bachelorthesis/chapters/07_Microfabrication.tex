...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/Photos/Microfabrication/MaN_holes.png}
    \caption{Picture of the holes seen in the isolation layer of the overbaked sample with the $\textit{MA-N 1407}$ photoresist. The sample was overbaked at 100C$^\circ$ for 20 minutes, and then underwent a stress test which included an acetone bath at 60C$^\circ$ for 10 minutes. The holes were deemed acceptable, as they were not large enough to impair the performance of the device.}
    \label{holes}
\end{figure}
...
\subsection{Lithography of gold plates}
\subsection{Cross-linking through overbaking}
\subsection{Lithography of CPW}
\subsection{etching and gold aufdampfen}
