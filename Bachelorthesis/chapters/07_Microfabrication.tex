...
This method showed great durability and seemed to be able to withstand the stress test, even at a dose of 1000 $mJ/cm^2$. However, there were multiple stripes visible on the sample at all doses, which pointed to a high variance in thickness. To test this, we used an atomic force microscope (AFM) to investigate the thickness of the photoresist, which is shown in figure \ref{AFM_1}.
